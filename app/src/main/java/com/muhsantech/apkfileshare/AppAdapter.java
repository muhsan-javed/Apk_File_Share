...
public class AppAdapter extends RecyclerView.Adapter<AppAdapter.AppViewHolder>{
    ...
    private String getHumanReadableSize(long apkSize) {
        ...
        if (apkSize<1024){
            ...
            humanReadableSize = String.format(context.getString(R.string.app_size_Kib),(double) (apkSize/1024));
        }else if (apkSize < Math.pow(1024,3)){
            humanReadableSize = String.format(context.getString(R.string.app_size_mib),(double) (apkSize/Math.pow(1024,2)));
        }else {
